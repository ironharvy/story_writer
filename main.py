...
def main():
    ...
    with open(output_filename, "w", encoding="utf-8") as f:
        ...
        f.write("## Generation Context\n")
        f.write(f"- Model: {args.model}\n")
        f.write(f"- Max Tokens: {args.max_tokens}\n")
        f.write(f"- Optimized Modules: {args.use_optimized}\n")
        f.write(f"- Images Enabled: {args.enable_images}\n")
        f.write(f"- Chapter Inpainting Enabled: {args.inpaint_chapters}\n")
        if args.inpaint_chapters:
            f.write(f"- Chapter Inpainting Ratio: {args.inpaint_ratio}\n")
        f.write("\n")
        f.write("### Initial Idea\n")
        f.write(f"{idea}\n\n")
        f.write("### Ideation Q&A\n")
        f.write(f"{qa_text}\n\n")
        f.write("### World Bible Q&A\n")
        f.write(f"{wb_qa_text}\n\n")
